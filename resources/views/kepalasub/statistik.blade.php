...
@section('title', 'Statistik - Kepala Sub')
    ...
    <div class="flex-1 flex flex-col">
        ...
        <main class="flex-1 bg-white">
            <div class="bg-gradient-to-b from-white to-blue-50 h-full w-full px-9 py-8 flex-grow">
                ...
                <!-- Filter -->
                <form method="GET" action="{{ route('kepalasub.statistik') }}" class="flex flex-wrap gap-4 mb-6">
                    ...
                    <a href="{{ route('kepalasub.statistik') }}" class="px-6 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600 transition-colors">
                        Reset
                    </a>
                </form>
                ...
                <div class="flex flex-wrap gap-4 mb-6">
                    <div class="bg-[#F0F2FF] shadow-lg px-6 py-4 rounded-xl text-center flex-1">
                        ...
                        <div class="text-2xl font-bold">{{ $suratMenungguPersetujuan }}</div>
                    </div>
                    <div class="bg-[#F0F2FF] shadow-lg px-6 py-4 rounded-xl text-center flex-1">
                        <div class="text-gray-500">Disetujui</div>
                        <div class="text-2xl font-bold">{{ $suratDisetujui }}</div>
                    </div>
                    <div class="bg-[#F0F2FF] shadow-lg px-6 py-4 rounded-xl text-center flex-1">
...
new Chart(document.getElementById('pieChart'), {
    ...
    data: {
        ...
        datasets: [{
            ...
            backgroundColor: ['#6366f1', '#34d399', '#ef4444']
        }]
    },
    options: {
        responsive: true,
