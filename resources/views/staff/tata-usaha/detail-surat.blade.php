        ...
        <main class="flex-1 p-4 sm:p-6 md:p-8 lg:p-10">
            <div class="container mx-auto">
                <div class="flex justify-end gap-2 mb-6">
                    <!-- Approve Form -->
                    <form id="form-approve" action="{{ route('tatausaha.surat.approve', $surat->id_surat) }}" method="POST" class="inline">
                        @csrf
                        <button type="button"
                    ...
                    <!-- Kembali -->
                    <a href="{{ route('tatausaha.tinjausurat') }}"
...
function tolakSurat() {
    if (confirm('Apakah Anda yakin ingin menolak surat ini?')) {
        ...
        window.location.href = '{{ route("tatausaha.tinjausurat") }}';
    }
}
