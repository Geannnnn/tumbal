...
<div class="flex h-screen">
    ...
    <div class="flex-1 flex flex-col">
        ...
        <main class="flex-1 bg-white p-10">
            ...
            <div id="ajukanForm">
                <form id="formAjukan" action="{{ route('dosen.surat.update', $surat->id_surat) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
...
<script>
    ...
    // JavaScript untuk menangani input tujuan surat
