...
<div class="flex h-screen">
    ...
    <div class="flex-1 flex flex-col">
        ...
        <div class="flex-shrink-0 flex justify-center items-center w-1/3">
            <img src="https://via.placeholder.com/150" alt="Profile Image" class="w-40 h-40 rounded-full bg-purple-200 object-cover">
        </div>
        <div class="space-y-6 w-2/3">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-sm font-semibold">Adhyca Hafeez Wibowo</p>
                </div>
            </div>
            <div class="flex items-center space-x-4">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-sm font-semibold">dikali@gmail.com</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="rounded-3xl p-8" style="background-color: #F0F2FF;">
            ...
            <form class="flex-1 space-y-5">
                ...
                <input type="password" placeholder="Masukkan Kata Sandi Saat Ini ..." class="w-full p-2 text-xs border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none">
                </div>
                <div>
                <label class="block mb-1 text-sm font-semibold">Kata Sandi Baru</label>
                <input type="password" placeholder="Masukkan Kata Sandi Baru" class="w-full p-2 text-xs border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none">
                </div>
                <div>
                <label class="block mb-1 text-sm font-semibold">Konfirmasi Kata Sandi Baru</label>
                <input type="password" placeholder="Masukkan kembali kata sandi baru ..." class="w-full p-2 text-xs border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none">
                </div>

                <div class="flex space-x-4 pt-4">
                <button type="button" class="flex-1 p-2 border border-[#5A67BA] text-[#5A67BA] rounded-sm hover:bg-blue-50 transition text-xs">Batal</button>
